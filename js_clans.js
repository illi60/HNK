...
(function () {
  ...
  var CRESTS = {
    ...
    mineur:   '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" fill="none"><path d="M 39 7 A 26 26 0 1 0 39 57 A 21 21 0 1 1 39 7 Z" fill="currentColor"/><circle cx="49" cy="19" r="2.6" fill="currentColor"/></svg>',
    ...
    shiranui: '<img src="https://cdn.jsdelivr.net/gh/illi60/hnk@main/clans/shiranui.svg" alt="" />',
...
'.hnkc-crow-crest svg,.hnkc-crow-crest img{width:100%;height:100%;display:block;object-fit:contain}',
...
'.hnkc-crest svg,.hnkc-crest img{width:100%;height:100%;display:block;object-fit:contain}',
